...
const { createProperty, showMyProperty, deleteProperty, showAllProperties, getSingleProperty, showSingleProperty, updateProperty, getPropertyByQuery } = require("../controllers/PropertyController");
